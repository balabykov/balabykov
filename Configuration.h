...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // KINGROON KP3
  #define DEFAULT_bedKp 32.40
  #define DEFAULT_bedKi  6.31
  #define DEFAULT_bedKd 110.40
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 802, 405 } // Verified real-world calibration (confirmed on-screen + test cube)
...
#define SKEW_CORRECTION
  ...
  #define XY_SKEW_FACTOR 0.0   // TODO: measure diagonals/side and update, or adjust live via M852
