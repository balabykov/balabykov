...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  30.0           // (Hz) User's own verified measurement, X axis unchanged
    ...
    #define SHAPING_FREQ_Y  28.3           // (Hz) TEMPORARY - Y bed changed to carbon (-900g), recalibrate
...
#define LIN_ADVANCE //GR linear advance
  ...
  #else
    #define ADVANCE_K 0.03        // (mm) Compression length applying to all extruders // typical for ~90% of filaments, retune per spool with M900 K
  #endif
